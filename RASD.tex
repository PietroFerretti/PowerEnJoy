...
\item{[G8] The system must stop charging the user as soon as the car is parked in a safe area and the user exits the car without notifying the system they are temporarily parking.
\begin{itemize}
	\item{[RE.6.1] The system must keep track until the end of the reservation of the amount the user has to pay.}
	...
	\item{[RE.8.2] If a reserved car has been parked in a safe area and the user has chosen to end the reservation, then the moment the last door has been closed the system must carry out the transaction for the amount that the system calculated, with the method of payment specified by the user on registration.}
...
\begin{itemize}
	\item{[RE.6.1] The system must keep track until the end of the reservation of the amount the user has to pay.}
se la macchina ha terminato la corsa (utente ha indicato di aver finito ed è uscito dalla macchina) ed è stata parcheggiata a una stazione con ricarica, ed è attaccata alla presa, il sistema applica il 30\% di sconto sul totale da pagare alla fine del viaggio
