...
\end{itemize}
	...
	\begin{tabular}{ |p{8cm}|m{2cm}|p{1cm}| }
		...
		\multicolumn{2}{|c|}{\textit{Total}} & \multicolumn{1}{c|}{60}\\
		\hline
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{ |p{8cm}|m{2cm}|p{1cm}| }
		\hline
		\multicolumn{1}{|c|}{\textit{EQ}} & \multicolumn{1}{c|}{\textit{Complexity}} & \multicolumn{1}{c|}{\textit{FPs}} \\
		\hline
		Get user info & Low & 3 \\
		\hline
		Get bills & Low & 3\\
		...
		\multicolumn{2}{|c|}{\textit{Total}} & \multicolumn{1}{c|}{39}\\
		\hline
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{ |p{8cm}|m{2cm}|p{1cm}| }
		\hline
		\multicolumn{1}{|c|}{\textit{EO}} & \multicolumn{1}{c|}{\textit{Complexity}} & \multicolumn{1}{c|}{\textit{FPs}} \\
		\hline
		Un/Lock car & Low & 4x2 \\
		\hline
		Car update & Average & 5\\
		\multicolumn{2}{|c|}{\textit{Total}} & \multicolumn{1}{c|}{13}\\
		\hline
	\end{tabular}
\end{center}
