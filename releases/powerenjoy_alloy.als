...
// using a pair of Int instead of Float)
sig Position{
	lat: one Int,
	lon: one Int
}
...
Areas can have any shape: we'll consider them 
...
sig P_Reserved, P_Available, P_InUse extends PlugStatus{} 
...
sig Ride {
	...
	// If MoneySavingOption is enabled it specified the chosen ChargingStation
}{
