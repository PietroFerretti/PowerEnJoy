...
\begin{figure}[H]
	\centering
	\makebox[\textwidth][c]{
		\includegraphics[width=400pt]{architecture_overview.png}
	}
...
3 tier,
1 client -> mobile/browser, car app, embedded systems
2 business logic -> central server. web server only for web app
3 database
