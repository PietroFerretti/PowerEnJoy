...
The PowerEnJoy system is 

a standalone system, completely new
offers no api to external systems
uses apis for driving licence verification and payment processing, more details in section \ref{apis}
...
]] non credo c'entri ma forse 
\subsubsection{Domain model}

qui testo per presentare i diagrammi
...
regolamentazioni
limitazioni dell'hardware (poca potenza)
